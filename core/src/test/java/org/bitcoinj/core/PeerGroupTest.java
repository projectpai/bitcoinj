...
public class PeerGroupTest extends TestWithPeerGroup {
    ...
    public void autoRescanOnKeyExhaustion() throws Exception {
        ...
        for (ECKey key1 : keys) {
            ...
            Block next = FakeTxBuilder.makeSolvedTestBlock(prev, FakeTxBuilder.createFakeTx(PARAMS, Coin.THOUSAND_1_5_COINS, addr));
        ...
        assertEquals(Coin.THOUSAND_1_5_COINS.multiply(3), wallet.getBalance());
