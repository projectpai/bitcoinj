...
public class FilteredBlockAndPartialMerkleTreeTests extends TestWithPeerGroup {
    ...
    public void createFilteredBlock() throws Exception {
        ...
        Transaction tx2 = FakeTxBuilder.createFakeTx(PARAMS, Coin.THOUSAND_1_5_COINS, key2.toAddress(PARAMS));
        Block block = FakeTxBuilder.makeSolvedTestBlock(PARAMS.getGenesisBlock(), Address.fromBase58(PARAMS, "Mdoucwwf2cLXfGmw6RA4C7XYi5NTw1NqPN"), tx1, tx2);
