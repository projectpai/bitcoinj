...
public class ScriptTest {
    ...
    public void testScriptSig() throws Exception {
        ...
        Address expected = ECKey.fromPublicOnly(pubKey).toAddress(PARAMS);

        // Test we can extract the from address.
        byte[] hash160 = Utils.sha256hash160(pubKey);
        Address actual = new Address(PARAMS, hash160);
    ...
    public void testScriptPubKey() throws Exception {
        ...
        Assert.assertTrue(pubkey.isSentToAddress());
        Address actual = pubkey.getToAddress(PARAMS);
        Address expected = new Address(PARAMS, pubkey.getPubKeyHash());
    ...
    public void testP2SHOutputScript() throws Exception {
        Address p2shAddress = GeneratorUtil.addressByP2SHHeader(MainNetParams.get());
    ...
    public void testCreateMultiSigInputScript() {
        ...
        ECKey key1 = DumpedPrivateKey.fromBase58(PARAMS, GeneratorUtil.privateKeyBase58(PARAMS))
            .getKey();
        ECKey key2 = DumpedPrivateKey.fromBase58(PARAMS, GeneratorUtil.privateKeyBase58(PARAMS))
            .getKey();
        ECKey key3 = DumpedPrivateKey.fromBase58(PARAMS, GeneratorUtil.privateKeyBase58(PARAMS))
            .getKey();
